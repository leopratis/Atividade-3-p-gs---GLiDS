...
import 'cadastro_email_nome_model.dart';
export 'cadastro_email_nome_model.dart';

class CadastroEmailNomeWidget extends StatefulWidget {
  const CadastroEmailNomeWidget({super.key});

  static String routeName = 'CadastroEmailNome';
  static String routePath = '/cadastroEmailNome';

  @override
  State<CadastroEmailNomeWidget> createState() =>
      _CadastroEmailNomeWidgetState();
}

class _CadastroEmailNomeWidgetState extends State<CadastroEmailNomeWidget> {
  late CadastroEmailNomeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroEmailNomeModel());
          ...
          child: Stack(
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    InkWell(
                      ...
                      onTap: () async {
                        context.pushNamed(CadastrEnderecoWidget.routeName);
                      },
                      child: Icon(
                        Icons.arrow_back,
              ...
              ClipRRect(
                ...
                child: Image.network(
                  'https://www.google.com/imgres?q=plano%20de%20fundo%20para%20aplicativo&imgurl=https%3A%2F%2Fpng.pngtree.com%2Fthumb_back%2Ffh260%2Fbackground%2F20211029%2Fpngtree-gradient-geometric-vertical-background-for-instagram-stories-device-landing-page-web-image_914127.png&imgrefurl=https%3A%2F%2Fpt.pngtree.com%2Ffree-backgrounds-photos%2Faplicativo&docid=WDY0JeWMwnBK7M&tbnid=4glke70ASqBw0M&vet=12ahUKEwjV9uLnz_CWAxXWlZUCHQHREyMQnPAOegUIkAEQAA..i&w=360&h=768&hcb=2&ved=2ahUKEwjV9uLnz_CWAxXWlZUCHQHREyMQnPAOegUIkAEQAA',
                  width: double.infinity,
                  height: double.infinity,
                  fit: BoxFit.cover,
                ),
              ...
              Padding(
                padding: EdgeInsetsDirectional.fromSTEB(50.0, 100.0, 50.0, 0.0),
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                  children: [
                    Text(
                      'Cadastre seu email e nome abaixo',
                      ...
                      child: Container(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            suffixIcon: InkWell(
                              onTap: () async {
                                safeSetState(() => _model.tFSenhaVisibility =
